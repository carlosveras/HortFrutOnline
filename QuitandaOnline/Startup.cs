...
namespace HortFrutOnline
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddEntityFrameworkStores<HortFrutOnlineContext>()
            ...
            services.AddDbContext<HortFrutOnlineContext>(options =>
                    options.UseSqlite(Configuration.GetConnectionString("HortFrutOnlineSqlite")));
